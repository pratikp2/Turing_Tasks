...
public:
    ...
    void performMove() {
        if (movementStrategy) movementStrategy->move();
        else std::cout << "No movement strategy set.\n";
    }

    void performAttack() {
        if (combatStrategy) combatStrategy->attack();
        else std::cout << "No combat strategy set.\n";
    }

    void performDefense() {
        if (defenseStrategy) defenseStrategy->defend();
        else std::cout << "No defense strategy set.\n";
    }
};
